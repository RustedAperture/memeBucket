  ...
  return (
    <div className="h-[100dvh] flex flex-col bg-background text-foreground overflow-hidden">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex h-14 w-full max-w-5xl items-center justify-between px-4 2xl:w-1/2 2xl:max-w-none">
      ...
      <main className="flex-1 flex flex-col min-h-0 mx-auto w-full max-w-5xl px-4 pt-8 pb-4 overflow-y-auto overflow-x-hidden 2xl:w-1/2 2xl:max-w-none">
        {children}
      </main>
      <footer className="border-t">
        <div className="container mx-auto flex w-full max-w-5xl flex-col gap-3 px-4 py-5 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between 2xl:w-1/2 2xl:max-w-none">
          <p>memeBucket</p>
